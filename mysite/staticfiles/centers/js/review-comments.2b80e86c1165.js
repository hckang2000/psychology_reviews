...
function loadComments(reviewId) {
    fetch(`/centers/reviews/${reviewId}/comments/`)
        .then(response => {
            if (!response.ok) {
...
function addComment(reviewId) {
    ...
    fetch(`/centers/reviews/${reviewId}/comments/add/`, {
        method: 'POST',
        headers: {
...
function saveComment(commentId) {
    ...
    fetch(`/centers/comments/${commentId}/update/`, {
        method: 'PATCH',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRFToken': getCookie('csrftoken')
...
function deleteComment(commentId) {
    ...
    fetch(`/centers/comments/${commentId}/delete/`, {
        method: 'DELETE',
        headers: {
            'X-CSRFToken': getCookie('csrftoken')
        }
